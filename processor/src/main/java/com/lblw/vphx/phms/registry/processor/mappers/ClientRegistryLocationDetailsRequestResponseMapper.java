...
/**
 * This is a helper to {@link ClientRegistryLocationDetailsRequestResponseMapper} and helps convert
 * request objects into their equivalent HL7 Soap request
 */
@Slf4j
@Component
public class ClientRegistryLocationDetailsRequestResponseMapper {
   ...
   */
  public ClientRegistryLocationDetailsRequestResponseMapper(
  ...
  /**
   * This transforms {@link ProvincialLocationDetailsCriteria} to its equivalent {@link
   * ProvincialLocationDetailsRequest}
   *
   * @param provincialLocationDetailsCriteria An instance of {@link
   *     ProvincialLocationDetailsCriteria} that must be converted.
   * @return provincialLocationDetailsRequest {@link ProvincialLocationDetailsRequest} containing
   *     search criteria
   */
  public @NonNull ProvincialLocationDetailsRequest convertSearchCriteriaToRequest(
      @NonNull ProvincialLocationDetailsCriteria provincialLocationDetailsCriteria) {

    ProvincialLocationDetailsRequest.ProvincialLocationDetailsRequestBuilder<?, ?>
        provincialLocationDetailsRequestBuilder = ProvincialLocationDetailsRequest.builder();

    provincialLocationDetailsRequestBuilder.requestBodyTransmissionWrapper(
        buildHl7v3RequestBodyTransmissionWrapper());

    setRequestBodyControlAct(
        provincialLocationDetailsCriteria, provincialLocationDetailsRequestBuilder);
    provincialLocationDetailsRequestBuilder.provincialRequestPayload(
        provincialLocationDetailsCriteria);
    return provincialLocationDetailsRequestBuilder.build();
  }
   ...
   *
   * @param provincialLocationDetailsCriteria
   * @param provincialLocationDetailsRequestBuilder {@link
  ...
  private void setRequestBodyControlAct(
      ...
      ProvincialLocationDetailsRequest.ProvincialLocationDetailsRequestBuilder<?, ?>
          provincialLocationDetailsRequestBuilder) {
    provincialLocationDetailsRequestBuilder.requestControlAct(
        RequestControlAct.builder()
            .eventRoot(provincialRequestProperties.getRequest().getSender().getControlActRoot())
            .eventCorrelationId(
                provincialLocationDetailsCriteria.getProvincialRequestControl().getRequestId())
            .build());
  }
}
